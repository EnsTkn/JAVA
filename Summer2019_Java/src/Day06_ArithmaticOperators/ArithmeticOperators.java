...
public class ArithmeticOperators {
	 ...
	 * from another number : multiplication, multiplies / : devision, devides
	 * 
...
//% :  returns the remainder
		/*
		 * 10/3 ==> 3 with rmainder of 1 12/5 ==> 2 with remainder : 12 - 5*2 = 2
		 * 
		 * 20/3 ==> 6 : 20 - 6 * 3 =2
		 * 
		 */
		...
		/*
		 * 
		 * 20, 45, 65, 67 , 68 even: can be devided by 2 without a remainder odd:
		 * devided by 2, will have remainder
		 * 
		 * 
		 */
