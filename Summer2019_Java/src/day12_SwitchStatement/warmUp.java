...
public class warmUp {
	...
	/*
	 * Warm up: declare 3 numbers if n1 and n2 are equal => n1&n2 are equal
	 * 
	 * if n2 and n3 are equal ==> n2&n3 are equal if n3 and n1 are qual ==>n3&n1 are
	 * equal if all equal ==> all equal if none of them are euqal ==> none of them
	 * are equal Do Not use single if statement
	 * 
	 */
	...
	public static void main(String[] args) {
		...
		/*
		 * 
		 * 60~70 => D 70 ~ 80 => C 80 ~90 => B 90 ~ 100 => A done 0~59 =>F
		 * 
		 * grade must be: 0~100
		 */
