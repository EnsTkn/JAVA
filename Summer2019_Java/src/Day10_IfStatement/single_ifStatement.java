...
public class single_ifStatement {
	...
	public static void main(String[] args) {
		...
		/*
		 * in order to n1 be the maximum : n1 > n2 && n1 > n3 in order to n2 be the
		 * maximum : n2 > n1 && n2 > n3 in order to n3 be the maximum : n3 > n1 && n3 >
		 * n2
		 * 
		 */
		...
		/*
		 * number to be postive: number >0 number to be negative: number < 0 number to
		 * be zero: number ==0
		 * 
		 */
		if (number > 0) {
